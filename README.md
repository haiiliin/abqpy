...
[![coveralls](https://coveralls.io/repos/github/haiiliin/abqpy/badge.svg?branch=2027)](https://coveralls.io/github/haiiliin/abqpy?branch=2027)
...
```
pip install -U abqpy==2017.*  # change the major version to match your Abaqus version
```
