...
[![coveralls](https://coveralls.io/repos/github/haiiliin/abqpy/badge.svg?branch=2020)](https://coveralls.io/github/haiiliin/abqpy?branch=2020)
...
```
pip install -U abqpy==2020.*  # change the major version to match your Abaqus version
```
