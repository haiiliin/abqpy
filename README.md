...
[![coveralls](https://coveralls.io/repos/github/haiiliin/abqpy/badge.svg?branch=2021)](https://coveralls.io/github/haiiliin/abqpy?branch=2021)
...
```
pip install -U abqpy==2021.*  # change the major version to match your Abaqus version
```
