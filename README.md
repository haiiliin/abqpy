...
[![coveralls](https://coveralls.io/repos/github/haiiliin/abqpy/badge.svg?branch=2019)](https://coveralls.io/github/haiiliin/abqpy?branch=2019)
...
```
pip install -U abqpy==2019.*  # change the major version to match your Abaqus version
```
