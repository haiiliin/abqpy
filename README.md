...
<<<<<<< HEAD
[![Build Status](https://app.travis-ci.com/haiiliin/abqpy.svg?branch=V2016)](https://app.travis-ci.com/haiiliin/abqpy)
...
Using `pip`:
```shell
pip install abqpy==2016.3.3
```
Using `conda`:
```shell
conda install -c haiiliin abqpy=2016.3.3
```
