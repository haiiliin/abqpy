...
[![coveralls](https://coveralls.io/repos/github/haiiliin/abqpy/badge.svg?branch=2018)](https://coveralls.io/github/haiiliin/abqpy?branch=2018)
...
```
pip install -U abqpy==2018.*  # change the major version to match your Abaqus version
```
