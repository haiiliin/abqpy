...
[![coveralls](https://coveralls.io/repos/github/haiiliin/abqpy/badge.svg?branch=2026)](https://coveralls.io/github/haiiliin/abqpy?branch=2026)
...
```
pip install -U abqpy==2026.*  # change the major version to match your Abaqus version
```
