...
<<<<<<< HEAD
[![Build Status](https://app.travis-ci.com/haiiliin/abqpy.svg?branch=V2022)](https://app.travis-ci.com/haiiliin/abqpy)
...
=======
>>>>>>> 08f94c0 (Remove extra badges in READMEs to keep it clean (#1708))
...
Using `pip`:
```shell
pip install abqpy==2022.3.3
```
Using `conda`:
```shell
conda install -c haiiliin abqpy=2022.3.3
```
