...
````{tab} conda
```{code-block} shell
conda install conda-forge::abqpy=2019
```
````
...
- Use the `abaqus` command in the command line:
  ...
  ```
  See [here](https://help.3ds.com/2019/English/DSSIMULIA_Established/SIMACAEEXCRefMap/simaexc-c-caeproc.htm?contextscope=all)
