...
- Create an Abaqus Model
  ...
  ![](images/model-code.gif){#model-code title="Create an Abaqus Model", width=100%, align=center}

- Extract Output Data

  ![](images/output-code.gif){#output-code title="Extract Output Data", width=100%, align=center}
