...
class AbaqusDoc:
    ...
    def _add_link_in_method_or_function_docstring(
        ...
        if not docstring:
            return docstring
        link, link_with_label = cls._method_or_function_link(
    ...
    def add_link_in_class_docstring(
        ...
        str
            The docstring with the link to the Abaqus documentation.
        """
        return cls._add_link_in_class_or_module_docstring("class", class_name, docstring, prefix, suffix, label)
    ...
    def add_link_in_module_docstring(
        ...
        str
            The docstring with the link to the Abaqus documentation.
        """
        return cls._add_link_in_class_or_module_docstring("module", module_name, docstring, prefix, suffix, label)
