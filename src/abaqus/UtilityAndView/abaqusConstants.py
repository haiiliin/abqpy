...
K110 = SymbolicConstant.K110
UNARY_NEGATIVE = SymbolicConstant.UNARY_NEGATIVE
HYPERBOLIC_COSINE = SymbolicConstant.HYPERBOLIC_COSINE
INVERSE_COSINE = SymbolicConstant.INVERSE_COSINE
INVERSE_SINE = SymbolicConstant.INVERSE_SINE
HYPERBOLIC_TANGENT = SymbolicConstant.HYPERBOLIC_TANGENT
INVERSE_TANGENT = SymbolicConstant.INVERSE_TANGENT
NORMALIZE = SymbolicConstant.NORMALIZE
DEG2RAD = SymbolicConstant.DEG2RAD
RAD2DEG = SymbolicConstant.RAD2DEG
SMOOTH = SymbolicConstant.SMOOTH
SWAP = SymbolicConstant.SWAP
AVERAGE_ALL = SymbolicConstant.AVERAGE_ALL
