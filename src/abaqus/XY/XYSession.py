...
from ..UtilityAndView.abaqusConstants import (ABSOLUTE, ACCELERATION, ACOUSTIC_INTENSITY, ADD,
                                              ANGLE, ANGULAR_MOMENTUM, ARC_LENGTH, AREA,
                                              AREA_VELOCITY_SQUARED, AVERAGE, AVERAGE_ALL, BIMOMENT,
                                              Boolean, COMPLEX_MAGNITUDE, COMPLEX_PHASE,
                                              COMPLEX_VAL_AT_ANGLE, COMPONENT, CORIOLIS_LOAD,
                                              COSINE, CROSS, CURVATURE, DAMAGE, DAMAGE_CRITERION,
                                              DASHED, DEFORMED, DEG2RAD, DENSITY,
                                              DENSITY_ROTATIONAL_ACCELERATION, DISPLACEMENT, DIVIDE,
                                              DOTTED, DOT_DASH, ECURRENT_AREA_TIME, ELECTRIC_CHARGE,
                                              ELECTRIC_CURRENT, ELECTRIC_CURRENT_AREA,
                                              ELECTRIC_POTENTIAL, ELEMENT_CENTROID, ELEMENT_FACE,
                                              ELEMENT_NODAL, ENERGY, ENERGY_DENSITY,
                                              ENERGY_RELEASE_RATE, EPOTENTIAL_GRADIENT, EXPONENTIAL,
                                              FILLED_CIRCLE, FILLED_DIAMOND, FILLED_SQUARE,
                                              FILLED_TRI, FORCE, FORCE_VOLUME, FREQUENCY,
                                              GENERAL_PARTICLE, HEAT_FLUX, HEAT_FLUX_AREA,
                                              HEAT_FLUX_RATE, HEAT_FLUX_VOLUME, HOLLOW_CIRCLE,
                                              ...
                                              INVERSE_TANGENT, LENGTH, LINEAR_PRESSURE, LOG, LUMIN,
                                              MASS, MASS_FLOW_AREA, MASS_FLOW_AREA_RATE,
                                              MASS_FLOW_RATE, MAXIMUM, MAXIMUM_ENVELOPE, MINIMUM,
                                              MINIMUM_ENVELOPE, MODE_NUMBER, MOMENT, MULTIPLY,
                                              NATURAL_LOG, NODAL, NONE, NORMALIZE, NORM_DISTANCE,
                                              NUMBER, OFF, ON, PATH, PATH_POINTS, PHASE, POINT,
                                              POSITION, POWER, PRESSURE, PRESSURE_GRADIENT, RAD2DEG,
                                              RANGE, RANGE_ALL, RATE, REAL, ROTARY_INERTIA,
                                              ROTATIONAL_ACCELERATION, ROTATIONAL_VELOCITY, SEQ_ID,
                                              SINE, SMOOTH, SOLID, SQUARE_ROOT, SRSS, STATUS,
                                              STRAIN, STRAIN_RATE, STRESS, STRESS_INTENS_FACTOR,
                                              SUBSTANCE, SUBTRACT, SWAP, SymbolicConstant, TANGENT,
                                              TEMPERATURE, THICKNESS, TIME, TIME_HEAT_FLUX,
                                              TIME_HEAT_FLUX_AREA, TIME_INCREMENT, TIME_VOLUME,
                                              TIME_VOLUME_FLUX, TRUE_DISTANCE, TRUE_DISTANCE_X,
                                              TRUE_DISTANCE_Y, TRUE_DISTANCE_Z, TWIST,
                                              UNARY_NEGATIVE, UNDEFORMED, UNIFORM_SPACING, VELOCITY,
                                              VELOCITY_SQUARED, VOLUME, VOLUME_FLUX,
                                              VOLUME_FLUX_AREA, VOLUME_FRACTION, WHOLE_ELEMENT,
                                              WHOLE_MODEL, WHOLE_PART_INSTANCE, WHOLE_REGION,
                                              XMARKER, X_COORDINATE, Y_COORDINATE, Z_COORDINATE)
...
class XYSession(XYSessionBase):
    ...
    def LineStyle(
        color: str = "",
        show: Boolean = ON,
        style: Literal[SOLID, DASHED, DOTTED, DOT_DASH] = SOLID,
        thickness: float = 0,
    ) -> LineStyle:
