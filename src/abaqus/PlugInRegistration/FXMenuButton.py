...
class FXMenuButton(FXLabel):
    ...
    MENUBUTTON\_DOWN, etc. Next, there are several attachment modes; the popup's left/bottom edge may attach
    ...
    set to appear; this can be turned off by passing the option MENUBUTTON\_NOARROWS.
    """
