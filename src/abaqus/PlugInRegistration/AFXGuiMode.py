...
class AFXGuiMode(AFXMode):
    ...
    def activate(self):
        """Performs the necessary tasks when the mode is activated. Reimplemented in AFXForm, and AFXProcedure."""
    ...
    def commit(self):
        """Performs the necessary tasks when a dialog box of the mode commits. Implemented in AFXForm, and AFXProcedure."""

    def continueMode(self):
        """Virtual method that must be defined in the derived class--used to get the next dialog box or step in the mode. Implemented in AFXForm, and AFXProcedure."""

    def deactivate(self):
        """Performs the necessary tasks when the mode is deactivated. Reimplemented in AFXProcedureForm, and AFXProcedure."""
    ...
    def verifyCurrentKeywordValues(self):
        """Checks whether keywords of active commands for the current dialog box contain valid data and, if not, posts a dialog box with an error message. Reimplemented in AFXProcedure."""
