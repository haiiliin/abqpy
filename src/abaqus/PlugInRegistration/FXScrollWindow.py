...
class FXScrollWindow:
    ...
    def getContentHeight(self):
        """Return the height of the contents. Reimplemented from FXScrollArea. Reimplemented in AFXOptionTreeList."""

    def getContentWidth(self):
        """Return the width of the contents. Reimplemented from FXScrollArea. Reimplemented in AFXOptionTreeList."""

    def moveContents(self, x: int, y: int):
        """Move contents to the specified position. Reimplemented from FXScrollArea. Reimplemented in AFXOptionTreeList.
