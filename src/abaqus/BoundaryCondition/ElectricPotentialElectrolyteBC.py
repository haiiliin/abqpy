...
@abaqus_class_doc
class ElectricPotentialElectrolyteBC(BoundaryCondition):
    """The ElectricPotentialElectrolyteBC object stores the data for an electrical potential in
    electrolyte boundary condition.
    The ElectricPotentialElectrolyteBC object is derived from the BoundaryCondition object.
    ...
    .. versionadded:: 2025
        The ``ElectricPotentialElectrolyteBC`` class was added.
    """
    ...
    def __init__(
        ...
        Returns
        -------
        ElectricPotentialElectrolyteBC
    ...
    def setValues(
        ...
        """This method modifies the data for an existing ElectricPotentialElectrolyteBC object in the step where it is
        created.
    ...
    def setValuesInStep(
        ...
        """This method modifies the propagating data for an existing ElectricPotentialElectrolyteBC object in the
        specified step.
