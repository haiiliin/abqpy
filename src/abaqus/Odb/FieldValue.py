...
class FieldValue:
    ...
    precision: typing.Optional[SymbolicConstant] = None
    ...
    elementLabel: typing.Optional[int] = None
    ...
    mises: typing.Optional[float] = None
    ...
    #: Conjugate data will be ignored in invariant calculation.
    tresca: typing.Optional[float] = None
    ...
    #: Conjugate data will be ignored in invariant calculation.
    press: typing.Optional[float] = None
    ...
    #: Conjugate data will be ignored in invariant calculation.
    inv3: typing.Optional[float] = None
    ...
    maxPrincipal: typing.Optional[float] = None
    ...
    #: indeterminate. Conjugate data will be ignored in invariant calculation.
    midPrincipal: typing.Optional[float] = None
    ...
    #: Conjugate data will be ignored in invariant calculation.
    minPrincipal: typing.Optional[float] = None
    ...
    #: indeterminate. Conjugate data will be ignored in invariant calculation.
    maxInPlanePrincipal: typing.Optional[float] = None
    ...
    minInPlanePrincipal: typing.Optional[float] = None
    ...
    #: indeterminate. Conjugate data will be ignored in invariant calculation.
    outOfPlanePrincipal: typing.Optional[float] = None
