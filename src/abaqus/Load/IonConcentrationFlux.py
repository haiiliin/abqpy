...
@abaqus_class_doc
class IonConcentrationFlux(Load):
    """The IonConcentrationFlux object stores the data for an ion concentration flux load.
    The IonConcentrationFlux object is derived from the Load object.
    ...
    def setValues(
        ...
        """This method modifies the data for an existing IonConcentrationFlux object in the step where it
        is created.
    ...
    def setValuesInStep(
        ...
        """This method modifies the propagating data for an existing IonConcentrationFlux object in the
        specified step.
