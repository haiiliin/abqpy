...
class StepModel(ModelBase):
    ...
    def FrequencyStep(
        ...
        residualModeRegion: typing.Optional[str] = None,
        residualModeDof: typing.Optional[str] = None,
        limitSavedEigenvectorRegion: typing.Optional[SymbolicConstant] = None,
    ) -> FrequencyStep:
    ...
    def StaticRiksStep(
        ...
        nlgeom: Boolean = OFF,
        adiabatic: Boolean = OFF,
        maxLPF: typing.Optional[float] = None,
        nodeOn: Boolean = OFF,
        ...
        initialArcInc: typing.Optional[float] = None,
        minArcInc: typing.Optional[float] = None,
        maxArcInc: typing.Optional[float] = None,
        matrixStorage: SymbolicConstant = SOLVER_DEFAULT,
        extrapolation: SymbolicConstant = LINEAR,
        fullyPlastic: str = "",
        noStop: Boolean = OFF,
