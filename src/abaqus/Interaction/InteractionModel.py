...
class InteractionModel(
    ...
    def contactDetection(
        ...
        separationTolerance: typing.Optional[float] = None,
        ...
        surfaceSmoothing: typing.Optional[SymbolicConstant] = None,
    ):
    ...
    def getSurfaceSeparation(self):
        ...
        Returns
        -------
        typing.Tuple[typing.Tuple[str, str, float, bool], ...]
    ...
    def CavityRadiation(
        ...
        ambientTemp: typing.Optional[float] = None,
        blocking: SymbolicConstant = BLOCKING_ALL,
        blockingSurfaces: typing.Optional[RegionArray] = None,
        ...
        cyclicImages: int = 2,
        cyclicRotPt: typing.Optional[ModelDot] = None, 
        cyclicRotEndPt: typing.Optional[ModelDot] = None, 
        cyclicSymPt: typing.Optional[ModelDot] = None, 
        ...
        periodicSymZ: typing.Optional[float] = None,
        periodicDistZ: typing.Optional[float] = None,
        ...
        reflectionSymZ: typing.Optional[float] = None,
    ) -> CavityRadiation:
    ...
    def SurfaceToSurfaceContactExp(
        ...
        halfThreadAngle: typing.Optional[str] = None,
        pitch: typing.Optional[str] = None,
        ...
        datumAxis: typing.Optional[DatumAxis] = None, 
        useReverseDatumAxis: Boolean = OFF,
        clearanceRegion: typing.Optional[Region] = None,
    ...
    def SurfaceToSurfaceContactStd(
        ...
        adjustSet: typing.Optional[Region] = None,
        enforcement: SymbolicConstant = SURFACE_TO_SURFACE,
        thickness: Boolean = ON,
        contactControls: str = "",
        tied: Boolean = OFF,
        ...
        bondingSet: typing.Optional[Region] = None,
        handedness: SymbolicConstant = RIGHT,
        normalAdjustment: typing.Optional[SymbolicConstant] = None,
