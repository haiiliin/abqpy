...
[![Build Status](https://app.travis-ci.com/haiiliin/abqpy.svg?branch=main)](https://app.travis-ci.com/haiiliin/abqpy)
...
使用 `pip`:
```shell
pip install abqpy==2017.3.2
```
使用 `conda`:
```shell
conda install -c haiiliin abqpy=2017.3.2
```
更好的方法是使用 * 来匹配特定版本：
```shell
