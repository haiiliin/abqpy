...
[![Build Status](https://app.travis-ci.com/haiiliin/abqpy.svg?branch=V2018)](https://app.travis-ci.com/haiiliin/abqpy)
...
使用 `pip`:
```shell
pip install abqpy==2018.3.3
```
使用 `conda`:
```shell
conda install -c haiiliin abqpy=2018.3.3
```
更好的方法是使用 * 来匹配特定版本：
```shell
