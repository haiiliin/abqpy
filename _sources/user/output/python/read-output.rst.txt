...
- Part instances
  ...
  The type of the object to which topNodeSet refers is OdbSet. After you create a variable that refers to a region, you can use the variable to refer to a subset of field output data, as described in :doc:`user/output/python/read-output:using regions to read a subset of field output data`.
